...
class SitarahV(pluginTemplate):
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for SitarahV start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
          ...
          if self.target_run:
            ...
            simcmd = '; '.join((
                ...
                ' '.join((
                    ...
                    '--cc',
                    '--binary',
                    '--top-module', 'MainDatapath_TestBench',
                    '--trace',
                    '--build',
                    '-j', '0',
                    '/home/mahmed/Documents/SitarahV/Design/RISCV_Config_PKG.sv',
                    '/home/mahmed/Documents/SitarahV/TestBenches/MainDatapath_TestBench.sv',
                ) + tuple(
                    os.path.join('/home/mahmed/Documents/SitarahV/Design', file)
                    for file in next(os.walk('/home/mahmed/Documents/SitarahV/Design/'))[-1]
                        if file != 'RISCV_Config_PKG.sv'
                )),
                f"{os.path.join(testentry['work_dir'], 'obj_dir', 'VMainDatapath_TestBench')} +MEMFILE={os.path.join(testentry['work_dir'], 'imem.hex')} +DMEMFILE={os.path.join(testentry['work_dir'], 'dmem.hex')} > {sig_file}",
                f'python3 /home/mahmed/Documents/SitarahV/SitarahV/env/lines_remover.py {sig_file}',
                f'python3 /home/mahmed/Documents/SitarahV/SitarahV/env/extra_signature_remover.py /home/mahmed/Documents/SitarahV/riscof_work/rv32i_m/I/src/jal-01.S/dut/DUT-SitarahV.signature'
            ))
          else:
            simcmd = 'echo "NO RUN"'
